    ...
    <div className="max-w-2xl mx-auto px-4 py-6 text-white">
      ...
      {notifications.length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-gray-300 text-lg">No new notifications</p>
        ...
        <div className="space-y-4">
          {notifications.map((notification, index) => (
            <motion.div
              ...
              className="bg-black/60 backdrop-blur-lg rounded-xl p-4 hover:bg-black/50 transition-colors cursor-pointer"
            >
